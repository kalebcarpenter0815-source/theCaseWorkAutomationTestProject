...
class DashboardTemplatesPage extends Page {
    ...
    get caseTemplatesInfoIconBtn() {
        return $('#infolabel-r12m__infoButton');
    }
    ...
    async expectCaseTemplatesInfoIconTextToBeCorrect() {
        const infoText = await this.getCaseTemplatesInfoIconText();
        expect(infoText).toBe("Easily create new cases with predefined types and data using Case Templates.");
