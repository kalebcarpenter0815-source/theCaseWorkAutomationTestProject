...
// ================================
   ...
   get addSlashEditCaseTemplateMainPageSaveButtonAtTopPage(){
    ...
    get blackWidowTemplate_CopyRow() {
        return $('//div[@role="row"][.//span[normalize-space()="Copy of Black Widow Template"]]');
    }
    ...
    get addSlashEditCaseTemplateForBlackWidowTemplate() {
        return $('//span[contains(text(), "Add/Edit Case Template")]');
    }

    async addSlashEditCaseTemplateForBlackWidowTemplateShowsUp() {
        await expect(this.addSlashEditCaseTemplateForBlackWidowTemplate).toBeDisplayed();
    }

    get addSlashEditCaseTemplateForBlackWidowTemplateNameInputField() {
        return $('#field-r106__control');
    }

    async enterAddSlashEditCaseTemplateForBlackWidowTemplateName(name) {
        await this.addSlashEditCaseTemplateForBlackWidowTemplateNameInputField.setValue(name);
        await this.addSlashEditCaseTemplateForBlackWidowTemplateNameInputField.waitForDisplayed();
        await this.addSlashEditCaseTemplateForBlackWidowTemplateNameInputField.waitForEnabled();
        await expect(this.addSlashEditCaseTemplateForBlackWidowTemplateNameInputField).toBeDisplayed();
        await expect(this.addSlashEditCaseTemplateForBlackWidowTemplateNameInputField).toBeEnabled();
        const input = await $('#field-r106__control');
        // Clear existing text
        await input.clearValue();
        // Type it again
        await input.setValue("Black Widow Template Edited");
    }

    get addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField() {
        return $('#field-r10b__control');
    }

    async enterAddSlashEditCaseTemplateForBlackWidowTemplateDescription(description) {
        await this.addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField.setValue(description);
        await this.addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField.waitForDisplayed();
        await this.addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField.waitForEnabled();
        await expect(this.addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField).toBeDisplayed();
        await expect(this.addSlashEditCaseTemplateForBlackWidowTemplateDescriptionInputField).toBeEnabled();
        const input = await $('#field-r10b__control');
        // Clear existing text
        await input.clearValue();
        // Type it again
        await input.setValue("This is the description for the Black Widow Template that has been edited");
    }

    // ===================================================
    // Deleting the Black Widow Template Tests Start Here
    // ===================================================
