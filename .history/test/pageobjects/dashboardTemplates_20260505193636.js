...
// ================================
   ...
   get addSlashEditCaseTemplateMainPageSaveButtonAtTopPage(){
    ...
    get blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton() {
        return $('');
    }

    async clickBlackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton() {
        await this.blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton.waitForDisplayed();
        await this.blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton.waitForEnabled();
        await expect(this.blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton).toBeDisplayed();
        await expect(this.blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton).toBeEnabled();
        await this.blackWidowTemplate_CopyRowThreeDotsButtonDeleteOptionConfirmationPopUpDeleteButton.click();
    }
}
