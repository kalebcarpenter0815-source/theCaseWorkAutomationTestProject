...
class DashboardPage extends Page {
    ...
    async openFilter() {
        ...
        try {
            ...
            await browser.execute((el) => {
                ...
                el.click();
            await this.maybeVisualPause(`Hovered on ${caseTitleLabel}`);
            }, myDropdown);
        }
        ...
        await browser.waitUntil(async () => {
            ...
            await this.maybeVisualPause(`Editor opened for ${caseTitleLabel}`);
    }
    ...
    async clickEveryMainFilter() {
        const simpleFilterList = [
            ...
            "Within 30 days",
            "Within 3 months"
            await this.maybeVisualPause(`Closed ${caseTitleLabel} and back on dashboard`);
        ];
