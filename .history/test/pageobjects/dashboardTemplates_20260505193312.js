...
// ================================
   ...
   get addSlashEditCaseTemplateMainPageSaveButtonAtTopPage(){
    ...
    get blackWidowTemplate_CopyAddSlashEditTemplateSaveButton() {
        return $('//button[@data-testid="edit-case-template-save"]');
    }
    ...
    get blackWidowTemplate_CopyAddSlashEditTemplateCancelButton() {
        return $('//button[@data-testid="edit-case-template-cancel"]');
    }
    ...
    async blackWidowTemplate_CopyAddSlashEditTemplateBackToCaseTemplatesButton() {
