...
class DashboardTemplatesPage extends Page {
    ...
    get descriptionClickHereButton() {
        return $('//span[contains(text(), "Click here")]');
    }

    async clickDescriptionClickHereButton() {
        await this.descriptionClickHereButton.click();
        expect(await this.descriptionClickHereButton.getText()).toBe("Click here");
    }
