...
// ================================
   ...
   get addSlashEditCaseTemplateMainPageSaveButtonAtTopPage(){
    ...
    get blackWidowTemplate_CopyllowedStatusesNewDropdownMenuButton() {
        return $('#field-r12u__control');
    }

    async clickAllowedStatusesNewDropdownMenuButton() {
        await this.allowedStatusesNewDropdownMenuButton.waitForDisplayed();
        await this.allowedStatusesNewDropdownMenuButton.waitForEnabled();
        await expect(this.allowedStatusesNewDropdownMenuButton).toBeDisplayed();
        await expect(this.allowedStatusesNewDropdownMenuButton).toBeEnabled();
        await this.allowedStatusesNewDropdownMenuButton.click();
    }
