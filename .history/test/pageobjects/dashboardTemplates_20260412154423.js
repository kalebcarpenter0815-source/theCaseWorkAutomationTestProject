...
class DashboardTemplatesPage extends Page {
    ...
    get caseTemplateRows() {
        ...
        return $$(
            '//h2[normalize-space()="Case Templates"]/ancestor::section[1]//tbody/tr | //h2[normalize-space()="Case Templates"]/ancestor::div[1]//div[@role="rowgroup"]//div[@role="row"]'
        );
    }

    get sidebarTemplatesBtn() {
        return $('//nav//a[.//span[normalize-space()="Templates"]]');
    }
