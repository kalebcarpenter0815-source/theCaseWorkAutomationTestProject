...
class DashboardClientsThirdPartiesPage extends Page {
    ...
    get previewSizesDropdown() {
        return $('//button[@aria-haspopup and (contains(normalize-space(.), "large") or contains(normalize-space(.), "small") or contains(normalize-space(.), "medium")) or contains(normalize-space(o))]');
    }
