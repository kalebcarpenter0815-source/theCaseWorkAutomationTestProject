...
class DashboardTemplatesPage extends Page {
    ...
    get removedDropdownMenuButtonSelectionRemoved() {
        return $('//input[@id="Removed:Removed"]');
    }

    async clickRemovedDropdownMenuButtonSelectionRemoved() {
        await this.removedDropdownMenuButtonSelectionRemoved.click();
        expect(await this.removedDropdownMenuButtonSelectionRemoved.isDisplayed()).toBeTruthy();
        expect(await this.removedDropdownMenuButtonSelectionRemoved.isEnabled()).toBeTruthy();
    }
}
