...
class DashboardClientsThirdPartiesPage extends Page {
    ...
    get searchLabel() {
        return $('//label[contains(normalize-space(.), "Search")] | //*[self::div or self::span][contains(normalize-space(.), "Search")]');
    }
    ...
    async waitForClientsThirdPartiesPage() {
        await browser.waitUntil(async () => {
            ...
            return currentUrl.toLowerCase().includes("clientsparties");
        }, {
            timeout: 15000,
            timeoutMsg: "Did not navigate to Clients / 3rd Parties URL"
        });
        ...
        await browser.waitUntil(async () => {
            ...
            return titleVisible || searchVisible || createVisible;
        }, {
            timeout: 15000,
