...
class DashboardClientsThirdPartiesPage extends Page {
    ...
    get previewSizesDropdown() {
        return $('//button[@aria-haspopup and (contains(normalize-space(.), "large") or contains(normalize-space(.), "small") or contains(normalize-space(.), "medium")) or contains(normalize-space(.), "option))] | //button[@aria-label="Preview Sizes"]');
    }
    ...
    get addPhoneNumberInputs() {
        return $$('input[data-testid="party-dialog-phone-input"]');
    }

    get phoneCardSelectPhoneTypeButtons() {
        return $$('//button[contains(@aria-label, "Select phone type")]');
    }

    get primaryContactToggle() {
        return $('//label[contains(normalize-space(.), "Primary Contact")]/following::input[@type="checkbox"][1]');
    }
    ...
    get clientsAndOrThirdPartiesRowByName() {
        return (clientName) => $(`//div[@role="row"][.//*[@role="gridcell"] and .//*[contains(normalize-space(.), "${clientName}")]] | //tr[td][.//*[contains(normalize-space(.), "${clientName}")]]`);
    }
    ...
    get clientCardPreviewName() {
        return $('//div[contains(@style,"colorNeutralCardBackground")][.//span[contains(normalize-space(.), "Client Name")]]//span[contains(@class, "fui-Avatar")]//following-sibling::span');
    }

    // List of all clients and third parties in the system, used for validation after creating/deleting clients
    get allClientsAndThirdPartiesNames() {
        return $$('//div[contains(@style,"colorNeutralCardBackground")][.//span[contains(@class, "fui-Avatar")]]//span[contains(@class, "fui-Avatar")]//following-sibling::span');
    }
    // Somebody Else, Quagmire Giggity, EVERYONE LLC, NO ONE Corps, AUTOTEST Client, AUTOTEST Client, cameron

    get allClientsAndThirdPartiesCards() {
        return $$('//div[@role="row"]');
    }

    get clientQuagmireGiggityCard() {
        return $('//div[@role="gridcell"]//span[text()="Quagmire Giggity"]');
    }

    get clientEVERYONELLCCard() {
        return $('//div[@role="gridcell"]//span[text()="EVERYONE LLC"]');
    }

    get clientNOONECorpsCard() {
        return $('//div[@role="gridcell"]//span[text()="NO ONE Corps"]');
    }

    get clientAUTOTESTClientCard() {
        return $('//div[@role="gridcell"]//span[text()="AUTOTEST Client"]');
    }

    get clientAUTOTESTClient2Card() {
        return $('//div[@role="gridcell"]//span[text()="AUTOTEST Client 2"]');
    }
