...
class DashboardTemplatesPage extends Page {
    ...
    getTemplateRowByName(templateName) {
        ...
        return $(`//tr[.//*[normalize-space()="${templateName}" or normalize-space()="${smartName}" or contains(normalize-space(),"Best Around")]] | //div[@role="row"][.//*[normalize-space()="${templateName}" or normalize-space()="${smartName}" or contains(normalize-space(),"Best Around")]]`);
    }
