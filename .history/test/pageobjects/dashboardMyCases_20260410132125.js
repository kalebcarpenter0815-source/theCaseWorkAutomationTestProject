...
class DashboardMyCasesPage extends Page {
    ...
    get editEventButton() {
        return $('//button[.//*[name()="path" and contains(@d,"M17.18 2.93")]]');
    }

    get deleteEventButton() {
        return $('//button[.//*[name()="path" and contains(@d,"M8.5 4h3")]]');
    }
    ...
    async selectUserByName(userName) {
        ...
        const checkbox = await $(
            `//input[@type="checkbox" and ancestor::*[contains(normalize-space(.), "${escapedName}")]][1] | ` +
            `//tr[.//*[contains(normalize-space(.), "${escapedName}")]]//input[@type="checkbox"][1] | ` +
            `//div[.//*[contains(normalize-space(.), "${escapedName}")]]//input[@type="checkbox"][1]`
        );
