...
class DashboardBillableTimePage extends Page {
    ...
    get timePeriodDropdown() {
        return $('//*[@data-testid="quick-insights-time-period-menu" or @data-testid="billable-time-stats-time-period-dropdown" or (self::button and contains(normalize-space(),"Time Span"))][1]');
    }

    get viewDropdown() {
        return $('//*[@data-testid="quick-insights-view-filter-menu" or @data-testid="billable-time-stats-view-dropdown" or (self::button and contains(normalize-space(),"View -"))][1]');
    }
