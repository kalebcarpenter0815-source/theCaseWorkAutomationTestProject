...
class DashboardMyCasesPage extends Page {
    ...
    async selectRetainedDate(month, day) {
        ...
        await browser.waitUntil(async () => {
            ...
            const dayButton = await leftGrid.$(`.//button[normalize-space()="${day}" or .//*[normalize-space()="${day}"]] | .//*[@role="gridcell" and normalize-space()="${day}"]`);
            return await dayButton.isDisplayed().catch(() => false);
