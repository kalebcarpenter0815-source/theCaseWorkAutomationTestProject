...
class DashboardTemplatesPage extends Page {
    ...
    async expandAllAllowedStatusGroups() {
        ...
        // Expand collapsed groups while sweeping through the scrollable panel.
    ...
    async ensureAllAllowedStatusesCheckedWithRetries(maxPasses = 4) {
        ...
        for (let pass = 0; pass < maxPasses; pass += 1) {
            ...
            for (let step = 0; step < 35; step += 1) {
                ...
                // Expand any collapsed groups that become visible as we scroll.
                await this.expandAllAllowedStatusGroups();
            ...
            const hasUnchecked = await this.hasUncheckedAllowedStatusCheckboxesInSweep();
