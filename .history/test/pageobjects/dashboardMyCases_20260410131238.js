...
class DashboardMyCasesPage extends Page {
    ...
    async toggleEventDueCheckbox() {
        await this.clickElement(this.eventDueCheckbox);
    }
    ...
    async closeEventEditor() {
        await this.clickElement(this.closeEventButton);
    }
    ...
    async cancelDeleteEvent() {
        await this.clickElement(this.confirmDeleteNoButton);
    }

    async confirmDeleteEvent() {
        await this.clickElement(this.confirmDeleteYesButton);
    }
