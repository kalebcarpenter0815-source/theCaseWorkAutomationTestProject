...
class DashboardClientsThirdPartiesPage extends Page {
    ...
    get editPartyNameInput() {
        return $('input[data-testid="party-dialog-name-input"], input[placeholder*="name of the Client / 3rd Party"], //label[contains(normalize-space(.), "Party Name")]/following::input[1]');
    }
    ...
    rowByClientName(clientName, occurrence = 1) {
        ...
        return $(`(//div[@role="row"][.//*[@role="gridcell"] and .//*[contains(normalize-space(.), ${safeText})]] | //tr[td][.//*[contains(normalize-space(.), ${safeText})]])[${occurrence}]`);
    }
