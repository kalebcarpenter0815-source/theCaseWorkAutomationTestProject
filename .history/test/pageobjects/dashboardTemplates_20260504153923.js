...
class DashboardTemplatesPage extends Page {
    ...
    get newDropdownMenuButtonNew() {
        return $('//input[@id="New:new"]');
    }

    async clickNewDropdownMenuButtonNew() {
        await this.newDropdownMenuButtonNew.click();
        expect(await this.newDropdownMenuButtonNew.isDisplayed()).toBeTruthy();
        expect(await this.newDropdownMenuButtonNew.isEnabled()).toBeTruthy();
    }
