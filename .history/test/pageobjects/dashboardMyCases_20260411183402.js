...
class DashboardMyCasesPage extends Page {
    ...
    async selectAllAssignableUsers() {
        ...
        for (const checkbox of checkboxes) {
            const isRoleCheckbox = (await checkbox.getAttribute("role").catch(() => "")) === "checkbox";
            const isSelected = isRoleCheckbox
                ? (await checkbox.getAttribute("aria-checked").catch(() => "false")) === "true"
