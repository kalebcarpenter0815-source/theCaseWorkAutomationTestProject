...
class DashboardTemplatesPage extends Page {
    ...
    get completedDropdownMenuButtonSelectionAutomationStatus() {
        return $('//input[@id="Completed:automation status"]');
    }

    async clickCompletedDropdownMenuButtonSelectionAutomationStatus() {
        await this.completedDropdownMenuButtonSelectionAutomationStatus.click();
        expect(await this.completedDropdownMenuButtonSelectionAutomationStatus.isDisplayed()).toBeTruthy();
        expect(await this.completedDropdownMenuButtonSelectionAutomationStatus.isEnabled()).toBeTruthy();
    }
}
