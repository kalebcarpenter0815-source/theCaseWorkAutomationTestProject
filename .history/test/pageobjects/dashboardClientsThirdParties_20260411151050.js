...
class DashboardClientsThirdPartiesPage extends Page {
    ...
    get addPhoneNumberInput() {
        return $('//label[contains(translate(normalize-space(.), "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), "phone number")]/following::input[1] | //input[contains(translate(@placeholder, "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), "phone")] | //input[contains(translate(@name, "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), "phone") and @type="text"] | //input[contains(@data-testid, "phone") and @type="text"]');
    }
    ...
    get phoneTypeInput() {
        return $('//label[contains(normalize-space(.), "Phone type")]/following::input[1]');
    }
    ...
    get phoneNumberSubmitButton() {
        return $('//button[normalize-space(.)="Submit" or normalize-space(.)="Create" or normalize-space(.)="Add" or @type="submit"]');
    }
