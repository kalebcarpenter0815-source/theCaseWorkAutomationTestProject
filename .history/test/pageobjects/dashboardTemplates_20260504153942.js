...
class DashboardTemplatesPage extends Page {
    ...
    get newDropdownMenuButtonSelectionVagueDisadvantage() {
        return $('//input[@id="New:vague disadvantage"]');
    }

    async clickNewDropdownMenuButtonSelectionVagueDisadvantage() {
        await this.newDropdownMenuButtonSelectionVagueDisadvantage.click();
        expect(await this.newDropdownMenuButtonSelectionVagueDisadvantage.isDisplayed()).toBeTruthy();
        expect(await this.newDropdownMenuButtonSelectionVagueDisadvantage.isEnabled()).toBeTruthy();
    }
}
