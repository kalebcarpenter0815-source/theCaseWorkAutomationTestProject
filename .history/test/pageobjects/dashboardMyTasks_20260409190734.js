...
class DashboardMyTasksPage extends Page {
    ...
    get caseAllCasesBtn() {
        return (caseCard) => caseCard.$('[data-testid="tasks-card-case-filter-dropdown"]');
    }

    // This getter is already selected so lets but it at the bottom of the list of case getters to avoid confusion. It is also the only one that uses a different selector than the title field.
