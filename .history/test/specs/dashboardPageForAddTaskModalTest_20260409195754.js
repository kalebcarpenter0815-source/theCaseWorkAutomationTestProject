...
describe('Dashboard Add Task Modal Tests', () => {
    ...
    it('should display Add Task modal form fields', async () => {
        ...
        const billableCheckbox = await dashboardAddTaskModal.billableCheckbox;
        ...
        await expect(billableCheckbox).toBeDisplayed();
    ...
    it('should complete Add Task form for each Assign To person with all Case selections', async () => {
        const taskDescriptionText = 'This task you gotta complete haha (lol)';
        ...
        for (const assignToPerson of assignToPersons) {
            ...
            for (const caseItem of cases) {
                ...
                await dashboardAddTaskModal.fillTaskToCompleteField(taskDescriptionText);
                ...
                const myTasksSection = await dashboardMyTasksPage.myTasksSection;
                await expect(myTasksSection).toBeDisplayed();
