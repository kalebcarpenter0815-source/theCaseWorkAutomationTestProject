...
describe("Dashboard Full Tests", () => {
    ...
    it("does the full beginner hover edit, save, reopen, and verify flow", async () => {
        ...
        const allowedEventTitles = ["Test", "Going to the movies"];
        expect(Boolean(result.eventTitleValue && result.eventTitleValue.trim())).toBe(true);
        expect(allowedEventTitles.includes(result.eventTitleValue)).toBe(true);
