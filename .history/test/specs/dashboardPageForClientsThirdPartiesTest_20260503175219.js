...
const searchNames = [
    ...
    "Redstone Alliance",
    "Titanium Healthcare",
    "Dragonfly Healthcare",
    "Stonebridge Renewables",
    "Nightfall Strategies",
    "Cypress Services",
    "Ironforge Healthcare",
    "Falcon Industries",
    "Redstone Works",
    "Wolfrun Inc",
    "Meridian Inc",
    "Trailhead Works",
    "Thunderpeak Creative",
    "Bearclaw Technologies",
    "Dawnbreak Partners",
    "Nightfall Renewables",
    "Shadowmere Strategies",
    "Eaglepeak Aerospace",
    "Summit Digital",
    "Ember Enterprises",
    ...
    "Bearclaw Resources",
    "Maplewood Studio",
    // Third screenshot (18 names):
    "Beacon Collective", "Hazelhurst Media", "Goldleaf Holdings", "Dragonfly Pharma",
    "Starlight Logistics", "Sunstone Foundation", "Ashford Analytics", "Ironwood Industries",
    "Stormwatch Global", "Sunstone Inc", "Dawnbreak Studio", "Ashford Services",
    "Firebrand Energy", "Vanguard Development", "Zenith Healthcare", "Trailhead Services",
    "Willowbrook Creative", "Blackthorn Technologies",
    // Fourth screenshot (19 names):
    "Northwind Renewables", "Alpine Engineering", "Meridian Alliance", "Redwood Consulting",
    "Blueridge Biotech", "Stonecroft Energy", "Whitecliff Pharma", "Shadowmere Digital",
    "Sundance Global", "Crimson Foundation", "Atlas Global", "Alpine Biotech",
    "Redstone Innovations", "Peregrine Alliance", "Driftwood Energy", "Summit Construction",
    "Atlas Networks", "Stonebridge Innovations", "Wildflower Enterprises",
    // Fifth screenshot (18 names):
    "Yarrow Research", "Swiftwater Corp", "Frostbite Design", "Windcrest Labs",
    "Meridian Renewables", "Sycamore Services", "Copper Works", "Yarrow Creative",
    "Harbor Inc", "Swiftwater Partners", "Hawkridge Inc", "Bearclaw Aerospace",
    "Orion Ventures", "Wolfrun Capital", "Alpine Labs", "Crimson Engineering",
    "Stormwatch Dynamics", "Ivywood Works",
    // Sixth screenshot (16 names):
    "Shadowmere Development", "Dragonfly Labs", "Peregrine Resources", "Hazelhurst Collective",
    "Sunstone Studio", "Meridian Creative", "Deepwater Analytics", "Redwood Corp",
    "Cedar Media", "Golden Design", "Brightpath Consulting", "Diamond Services",
    "Atlas Technologies", "Crystal Development", "Golden Media", "Pacific Advisors"
];
