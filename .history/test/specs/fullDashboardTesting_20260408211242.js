...
describe("Dashboard Full Tests", () => {
    ...
    it("runs Karen and Schmuck case-targeted edit flows", async () => {
        ...
        if (!didRunKarenFlow) {
            console.warn("Karen's Cat was not found/editable.");
        }
        ...
        if (!didRunSchmuckFlow) {
            console.warn("Schmuck case was not found/editable.");
        }

        if (!didRunKarenFlow) {
            throw new Error("Karen flow did not run; target case was not found or editable.");
        }

        if (!didRunSchmuckFlow) {
            throw new Error("Schmuck flow did not run; target case was not found or editable.");
        }
