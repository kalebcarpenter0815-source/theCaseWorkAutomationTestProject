...
describe("Dashboard My Tasks Tests", () => {
    ...
    it("should run all Sort selections for every Case dropdown option", async () => {
        const allCaseOptionTexts = await dashboardMyTasksPage.getCaseOptionTexts();
        ...
        for (const caseOptionText of allCaseOptionTexts) {
            await dashboardMyTasksPage.selectCaseOption(caseOptionText);
