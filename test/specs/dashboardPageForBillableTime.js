...
describe("Dashboard Billable Time Tests", () => {
    ...
    it("should cycle time periods and view options in order", async () => {
        ...
        await expect(dashboardBillableTimePage.timePeriodDropdown).toHaveAttribute("value", "Last 6 Months");
        await expect(dashboardBillableTimePage.viewDropdown).toHaveAttribute("value", "All Users Time");
    });
});
