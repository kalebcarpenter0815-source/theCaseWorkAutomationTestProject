...
class DashboardBillableTimePage extends Page {
    ...
    get billableTimeSection() {
        return $('//button[@data-testid="billable-time-stats-time-period-dropdown"]/ancestor::div[.//button[@data-testid="billable-time-stats-view-dropdown"]][1]');
    }
    ...
    get timePeriodDropdown() {
        return $('[data-testid="billable-time-stats-time-period-dropdown"]');
    }

    get viewDropdown() {
        return $('[data-testid="billable-time-stats-view-dropdown"]');
    }
    ...
    async selectTimePeriod(optionText) {
        ...
        await browser.waitUntil(async () => {
            return (await this.timePeriodDropdown.getAttribute("value")) === optionText;
        }, {
            timeout: 10000,
    ...
    async selectView(optionText) {
        ...
        await browser.waitUntil(async () => {
            return (await this.viewDropdown.getAttribute("value")) === optionText;
        }, {
            timeout: 10000,
